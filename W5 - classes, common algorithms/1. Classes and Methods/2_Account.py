...
class Account():
    ...
    def __str__(self):
        ...
        return TEMPLATE.format(number  = self.account_number,
    ...
    def withdraw(self, amount: float):
        ...
        if self.balance < amount:
            raise ValueError("Insufficient account balance.".format(self.balance))
...
class SavingsAccount():
    """
    Contains details about each savings account as well as the Annual Interest Rate for all savings accounts.
    """
    def __init__(self, account_number: int, account_holder_name: str, opening_balance: float, account_type: str = "Savings Account"):
        """
        Args:
            account_number: Unique 8-digit number which identifies your bank account.
            account_holder_name: The name on your account.
        ...
        self.account_number = account_number
        self.account_holder_name = account_holder_name
        self.savings_balance = opening_balance
        self.account_type = account_type
        SavingsAccount.annual_interest_rate = 1

    def __str__(self):
        return """Account number: {0}
        Account holder: {1}
        Savings balance: £{2:.2f}
        Account type: {3}""".format(
            self.account_number,
    ...
    def calculate_monthly_interest(self):
        ...
        self.savings_balance *= 1 + (SavingsAccount.annual_interest_rate - 1) / NUMBER_OF_PAY_PERIODS
    
    def test(self, new_rate):
        ...
        print("Balance sfter monthly interest rate: £{:.2f}".format(self.savings_balance))
...
my_savings_account.test(random() + 1)